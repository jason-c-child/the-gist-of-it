...
import {PROMPT, MOTD, HELP} from './config'
...
const main = async () => {
  ...
  if(_args.url) {
    if (_args.url === 'sample') _args.url = `https://gist.githubusercontent.com/ktilcu/ef1d416279e453389c5d4cf1e6fb708b/raw/160782d79e83b64da142969ccaa7f9cf1fa16e01/CreativeFamily.json`
